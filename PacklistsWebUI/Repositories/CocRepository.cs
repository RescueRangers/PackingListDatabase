  ...
  WHERE [CocId] = @CocId";
        ...
        public async Task<bool> Insert(COC coc)
        {
            ...
            using (var db = Connection)
            {
                ...
                var result = await db.ExecuteAsync(sql, new { coc.InventoryDate, coc.CocNumber, coc.CocId }).ConfigureAwait(false);
        ...
        public async Task<bool> Update(int id, COC coc)
        {
            ...
            using (var db = Connection)
            {
                ...
                var result = await db.ExecuteAsync(sql, new { coc.InventoryDate, coc.CocNumber, CocId = id }).ConfigureAwait(false);
